...
export const Hero: FC<HeroProps> = ({
  ...
  const metaIconStyle = {
    ...
    border: '1px solid rgba(77,212,182,0.38)',
    boxShadow: '0 6px 18px rgba(77,212,182,0.22)',
  };
    ...
    <section
      ...
      <div className="flex flex-wrap gap-3 my-4">
        <div className="flex items-center gap-3 px-3 py-3 rounded-xl min-w-[240px]" style={metaBoxStyle}>
          <div className="w-7 h-7 grid place-items-center rounded-lg" style={metaIconStyle} aria-hidden="true">
            <svg className="w-4.5 h-4.5 fill-[var(--accent-strong)]" viewBox="0 0 24 24">
